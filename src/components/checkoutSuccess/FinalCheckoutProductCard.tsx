    ...
    <>
      {products &&
        products?.map((item) => (
          <Card
            key={item.name}
            className="flex w-full sm:w-[592px] h-auto border border-special p-4"
          >
            <CardContent className="relative flex flex-col sm:flex-row gap-2 sm:gap-8">
              <div className="w-[120px] h-[100px] sm:w-[172px] p-3 sm:h-[138px] border-1 border-special rounded-md">
                <div
                  className={cn(
                    {
              ...
              <div className="flex flex-col flex-1 gap-2 sm:gap-4">
                ...
                <CardFooter className="flex justify-between p-0 text-lg sm:text-2xl font-medium text-icons">
                  <div>
                  ...
                  <p className="flex items-center gap-6 text-sm sm:text-lg">
